...
def test_count_cosines_from():
    ...
    expected = 6
    answer = count_cosines_from(4, 15, .01)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 7
    answer = count_cosines_from(5, 20, 0.3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 7
    answer = count_cosines_from(6, 25, 0.5)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 9
    answer = count_cosines_from(7, 30, 0.4)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 8
    answer = count_cosines_from(8, 35, 0.45)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)

    expected = 9
    answer = count_cosines_from(9, 40, 0.65)
...
def test_sum_unit_fractions_from():
    ...
    expected = 0.489261  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 15)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 0.768771  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 20)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 1.166019  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 30)
