...
def test_count_sines_from():
    ...
    expected = 11
    answer = count_sines_from(6, 22)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 11
    answer = count_sines_from(7, 23)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 12
    answer = count_sines_from(8, 24)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)

    expected = 13
    answer = count_sines_from(9, 25)
...
def test_count_sines_vs_cosines():
    ...
    expected = 120
    answer = count_sines_vs_cosines(120)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 131
    answer = count_sines_vs_cosines(130)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 139
    answer = count_sines_vs_cosines(140)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
    ...
    expected = 161
    answer = count_sines_vs_cosines(160)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)

    expected = 170
    answer = count_sines_vs_cosines(170)
    print('Test 7 expected:', expected)
    print('       actual:  ', answer)
