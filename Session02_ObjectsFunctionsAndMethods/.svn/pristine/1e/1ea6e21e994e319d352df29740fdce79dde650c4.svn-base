...
def turtle4():
    ...
    nate.pen = rg.Pen('blue', 5)
    nate.right(90)
    nate.forward(100)
    nate.paint_bucket = rg.PaintBucket('green')
    nate.begin_fill()
    nate.draw_regular_polygon(8, 50)
    nate.end_fill()
...
def turtle5():
    ...
    josh.paint_bucket = rg.PaintBucket('red')
    ken.paint_bucket = rg.PaintBucket('blue')

    josh.backward(150)
    josh.begin_fill()
    josh.draw_regular_polygon(20, 20)
    josh.end_fill()
