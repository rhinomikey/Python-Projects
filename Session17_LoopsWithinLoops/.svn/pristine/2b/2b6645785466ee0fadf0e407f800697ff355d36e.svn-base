...
def test_sum_numbers():
    ...
    expected = 81
    answer = sum_numbers(([6,9,10,3], [5], [15,17,13,3]))
    print('Expected and actual are:', expected, answer)
    
    expected = 83
    answer = sum_numbers(([5,4,6,9,1,5], [8,1,9,2,8,3,7,4,6,5]))
    print('Expected and actual are:', expected, answer)
    ...
    expected = 9981
    answer = sum_numbers(([999,888,777,555], [5097], [111,222,333,444,555]))
    print('Expected and actual are:', expected, answer)
...
def print_characters_slanted(sequence_of_strings):
    ...
    for i in range(len(seq)):
        ...
        for j in range(len(seq[i])):
            num_spaces += 1
            print(spaces * num_spaces,seq[i][j])
