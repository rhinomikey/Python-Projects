...
def draw_L(window, circle, r, c):
    ...
    """
    # ------------------------------------------------------------------
    # ALMOST: 2. Implement and test this function.
...
def draw_wall_on_right(rectangle, n, window):
    ...
    """
    # ------------------------------------------------------------------
    # ALMOST: 3. Implement and test this function.
    #     The testing code is already written for you (above).
    # ------------------------------------------------------------------
    ...
    for i in range(n):
        ...
        rect.corner_1.x = start_corner.x - (width)*i
        rect.corner_2.x = end_corner.x - (width)*i
