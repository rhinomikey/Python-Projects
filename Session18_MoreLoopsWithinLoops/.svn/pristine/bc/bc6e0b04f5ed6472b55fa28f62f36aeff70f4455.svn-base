...
def test_largest_number():
    ...
    expected = 77.1
    answer = largest_number([(23, 10, 45),
                             (14, 16, 71, 77.1, 10),
                             [15, 22, 39, 41]])
    print('Expected and actual are:', expected, answer)
...
def test_largest_negative_number():
    ...
    expected = -11
    answer = largest_negative_number([(-13, 1, -104),
                             (-413, -610, -11, 7, 10),
                             [1, -12, 3, 4]])
    print('Expected and actual are:', expected, answer)
    
    expected = None
    answer = largest_negative_number([(23, 10, 45),
                             (14, 16, 71, 77.1, 10),
                             [15, 22, 39, 41]])
    print('Expected and actual are:', expected, answer)
