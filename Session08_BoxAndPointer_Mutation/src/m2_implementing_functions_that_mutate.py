...
Authors: David Mutchler, Valerie Galluzzi, Mark Hays, Amanda Stouder,
         their colleagues and Nathan Gupta.  December 2015.
...
def test_swap_colors():
    ...
    msg1 += 'and the rectangle should be filled with WHITE'
    message = rg.Text(rg.Point(400, 100), msg1)
    message.attach_to(window)

    # At this point, the CIRCLE should be filled with BLACK
    #                   and the RECTANGLE filled with WHITE.
    window.render()
    window.continue_on_mouse_click()

    swap_colors(circle, rectangle)

    # At this point, the CIRCLE should be filled with WHITE
    #                   and the RECTANGLE filled with BLACK.
    msg2 = 'Now, the circle should be filled with WHITE\n'
