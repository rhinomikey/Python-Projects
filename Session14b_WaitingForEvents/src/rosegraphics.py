...
#                      (title, (Color, str)
    ...
    def continue_on_mouse_click(self,
        ...
        self.display_message(message, x_position, y_position)
    ...
    def display_message(self, message, x_position, y_position):
        if self.text_with_message:
            self.erase_message()
        ...
        self.text_with_message = Text(anchor_point, message)

        if self.initial_canvas:
            self.text_with_message.attach_to(self.initial_canvas)
            self.initial_canvas._renderShape(self.text_with_message,
                                             render_NOW=True)

    def erase_message(self):
        self.text_with_message.detach_from(self.initial_canvas)
