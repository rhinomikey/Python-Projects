...
def test_draw_points_on_circle():
    ...
    draw_points_on_circle(window, circle, 7, 'red')
    window.close_on_mouse_click()
...
def test_polygon():
    ...
    polygon(window, circle, 12, 'green', 5)
    window.close_on_mouse_click()
...
def test_fancy_polygon():
    ...
    fancy_polygon(window, circle, 20, 17, 'blue', 1)
    window.close_on_mouse_click()
