...
def test_init():
    ...
    print()
    print('Expected:', point, point1)
    print('Actual:  ', line.start, line.end)
...
def test_clone():
    ...
    print(line2)
    print('Expected: True')
    print('Actual:  ', line1 == line2)  # Should print: True
    print('Expected: False')
    print('Actual:  ', line1 is line2)  # Should print: False
    print('Expected: False')
    print('Actual:  ', line1.start is line2.start)  # Should print: False
    print('Expected: False')
    print('Actual:  ', line1.end is line2.end)  # Should print: False
...
def test_reverse():
    ...
    print('Expected: ', line1)  # Should print: Line[(30, 17), (50, 80)]
    print('Actual:   ', line1)

    line1.reverse()
    print('Expected: ', line1)  # Should print: Line[(50, 80), (30, 17)]
    print('Actual:   ', line1)
    print()
    print('Expected:   ', False)  # Should print: False
    print('Actual:     ', line1 == line2)

    line1.reverse()
    print('Expected: ', True)
    print('Actual:   ', line1 == line2)  # Should now print: True
...
def test_slope():
    ...
    print('Expected: .25')
    print('Actual: ',line1.slope())
    print()

    line2 = Line(Point(10, 10), Point(10, 5))
    print('Expected: inf')
    print('Actual: ',line2.slope())
    
    print()
    print('Expected: False')
    print('Actual: ',line2.slope() == 'inf')   # Should print False
...
def test_length():
    ...
    print('Expected: 66.0')
    print('Actual:  ',line1.length())  # Should print: 66.0
    print()
    ...
    line2 = Line(p3, p4)
    print('Expected: 5.0')
    print('Actual:  ',line2.length())  # Should print about 5.0
...
def test_get_number_of_clones():
    ...
    line5 = line1.clone()
    print('Expected: 3')
    print('Actual:  ',line1.get_number_of_clones())
    print()
    print('Expected: 0')
    print('Actual:  ',line2.get_number_of_clones())
    print()
    print('Expected: 1')
    print('Actual:  ',line3.get_number_of_clones())
    print()
    print('Expected: 0')
    print('Actual:  ',line4.get_number_of_clones())
    print()
    print('Expected: 0')
    print('Actual:  ',line5.get_number_of_clones())
...
def test_line_plus():
    ...
    line1 = Line(Point(700, 20), Point(300, 8))
    line2 = Line(Point(100, 13), Point(600, 8))
    line3 = line1.line_plus(line2)
    print('Expected: Line[(800, 33), (900, 16)]')
    print('Actual:  ',line3)
...
def test_line_minus():
    ...
    line1 = Line(Point(600, 60), Point(800, 90))
    line2 = Line(Point(200, 15), Point(700, 35))
    line3 = line1.line_minus(line2)
    print('Expected: Line[(400, 45), (100, 55)]')
    print('Actual:  ',line3)
...
def test_midpoint():
    ...
    print('Expected: Point(6, 15)')
    print('Actual:  ',line1.midpoint())  # Should print: Point(6, 15)
...
def test_is_parallel():
    ...
    print('Expected: True')
    print('Actual:  ',line1.is_parallel(line2))   # Should print: True
    print()
    print('Expected: True')
    print('Actual:  ',line2.is_parallel(line1))   # Should print: True
    print()
    print('Expected: False')
    print('Actual:  ',line1.is_parallel(line3))   # Should print: False
    print()
    print('Expected: False')
    print('Actual:  ',line1.is_parallel(line4))   # Should print: False
    print()
    print('Expected: True')
    print('Actual:  ',line1.is_parallel(line1))   # Should print: True
    print()
    print('Expected: True')
    print('Actual:  ',line4.is_parallel(line4))   # Should print: True
...
def test_intersection():
    ...
    line1 = Line(Point(10, 0),Point(20, 0))
    line2 = Line(Point(19, 2),Point(19, -3))

    # The following should print: Point(19, 0)
    print('Expected: Point(19, 0)')
    print('Actual:  ',line1.intersection(line2))
...
def test_reset():
    ...
    line1.reset()
    line2.reset()
    print('Expected: Line[(-3, -4), (3, 4)]')
    print('Actual:  ',line1)  # Should print: Line[(-3, -4), (3, 4)]
    print('Expected: Line[(0, 1), (10, 20)]')
    print('Actual:  ',line2)  # Should print: Line[(0, 1), (10, 20)]
...
class Line(object):
    ...
    def reverse(self):
        ...
        self.end1 = self.start
        self.start = self.end
        self.end = self.end1

        return Line(self.start, self.end1)
    ...
    def line_plus(self, other_line):
        ...
        """
        # --------------------------------------------------------------
        # DONE: 15. Implement and test this method.  You should have
        #   already implemented its TEST function (above).
        # --------------------------------------------------------------
    ...
    def is_parallel(self, line2):
        ...
        #   are "equal", you must ROUND each to (say) 6 decimal places.
        ...
        #   DON'T use:              a == b
        #   INSTEAD use:  round(a, 6) == round(b, 6)
        #
        # The latter compares the numbers rounded to 6 decimal places
        ...
        if line2.start.x == line2.end.x:
            line2_slope = math.inf
        else:
            line2_slope= (line2.end.y - line2.start.y) / (line2.end.x - line2.start.x)
                
        if round(self.slope(),10) == round(line2_slope,10):
            return True
        else:
            return False
    ...
    def intersection(self, other_line):
        ...
        """
        # --------------------------------------------------------------
        # DONE: 24. Implement and test this method.  You should have
        #   already implemented its TEST function (above).
        #
        ...
        slopeLine1 = self.slope()
        slopeLine2 = other_line.slope()
        
        xinterceptPoint = ((self.start.x*self.end.y-self.start.y*self.end.x)*
                           (other_line.start.x-other_line.end.x)-(self.start.x-self.end.x)*
                           (other_line.start.x*other_line.end.y-other_line.start.y*other_line.end.x))/((self.start.x-self.end.x)*
                            (other_line.start.y-other_line.end.y)-(self.start.y-self.end.y)*
                            (other_line.start.x-other_line.end.x))
        yinterceptPoint = ((self.start.x*self.end.y-self.start.y*self.end.x)*
                           (other_line.start.y-other_line.end.y)-(self.start.y-self.end.y)*
                           (other_line.start.x*other_line.end.y-other_line.start.y*other_line.end.x))/((self.start.x-self.end.x)*
                            (other_line.start.y-other_line.end.y)-(self.start.y-self.end.y)*
                            (other_line.start.x-other_line.end.x))
        ...
        if round(slopeLine1,10) == round(slopeLine2,10):
            return None
        elif self.end.x <= xinterceptPoint <= self.start.x or other_line.end.x <= xinterceptPoint <= other_line.start.x:
            return Point(xinterceptPoint,yinterceptPoint)
        else:
            return None
    ...
    def reset(self):
        ...
        Examples:
            ...
            print(line1)  # Should print: Line[(x1, y1), (x2, y2)]
                          # where (x1, y1) and (x2, y2) are the CURRENT
                          # coordinates of line1's endpoints.
