...
def test_practice_problem2a():
    ...
    expected = [1, 7, 13, 20, 26, 32, 38, 39]
    answer = practice_problem2a(0,8,1.2)
    print('Expected:', expected)
    print('Actual:  ', answer)
    
    expected = [12, 13, 14, 15, 18, 19, 20, 21, 25, 26, 27, 31]
    answer = practice_problem2a(9,12,-.2)
    print('Expected:', expected)
    print('Actual:  ', answer)
